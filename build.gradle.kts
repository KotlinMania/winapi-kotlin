...
kotlin {
    ...
    val xcf = XCFramework("Winapi")

    macosArm64 {
        binaries.framework { baseName = "Winapi"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Winapi"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Winapi"
        flattenPackage = "io.github.kotlinmania.winapi"
    }

    android {
        namespace = "io.github.kotlinmania.winapi"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "winapi-kotlin", version.toString())

    pom {
        name.set("winapi-kotlin")
        description.set("Kotlin Multiplatform port of retep998/winapi-rs - Raw FFI bindings for all of Windows API")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/winapi-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/winapi-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/winapi-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/winapi-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.winapi.codeql
