...
This file is the quick-reference operating contract for winapi-kotlin. The longer
...
winapi-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`winapi`](https://crates.io/crates/winapi). Upstream Rust is the behavioral oracle while the
