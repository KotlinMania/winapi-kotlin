...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Winapi.swiftmodule/`
...
//      `import Winapi` above would fail at compile time.
//
//   2. The static archive `libWinapi.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Winapi" }` and
//      `flattenPackage = "io.github.kotlinmania.winapi"` configuration in
...
final class WinapiExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Winapi swift module imported cleanly")
    }
}
